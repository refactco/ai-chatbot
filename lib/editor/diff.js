/**
 * ProseMirror Document Diffing
 *
 * This file provides utilities for comparing and patching ProseMirror documents.
 * It enables diff-based comparison and visualization of document changes.
 *
 * Features:
 * - Document node comparison and patching
 * - Text-level diffing with diff-match-patch
 * - Node equality computation
 * - Diff mark generation
 * - Tree traversal and manipulation
 *
 * Modified from https://github.com/hamflx/prosemirror-diff/blob/master/src/diff.js
 * This implementation enables the diffing view to show deleted and inserted content.
 */
...
/**
 * Enumeration of diff types
 * Used to mark nodes as unchanged, deleted, or inserted
 */
...
/**
 * Patches a document node with changes from a new node
 * Creates a new document highlighting differences between versions
 *
 * @param schema - ProseMirror schema for creating nodes
 * @param oldNode - Original document node
 * @param newNode - Modified document node
 * @returns Patched document node with diff marks
 */
export const patchDocumentNode = (schema, oldNode, newNode) => {
  // Ensure nodes have compatible types
  ...
  // Find unchanged nodes from the left
  ...
  // Find unchanged nodes from the right
  ...
  // Process the differing sections
...
/**
 * Finds matching node sequences between old and new children
 * Used to identify unchanged sections of content
 *
 * @param schema - ProseMirror schema
 * @param oldChildren - Array of nodes from original document
 * @param newChildren - Array of nodes from modified document
 * @returns Array of match objects with start/end indices and counts
 */
...
/**
 * Finds the index of a matching node in an array of children
 *
 * @param children - Array of nodes to search
 * @param node - Node to find
 * @param startIndex - Index to start search from
 * @returns Index of matching node or -1 if not found
 */

...
export const BrainIcon = ({ size = 16 }: { size?: number }) => {
  return (
    ...
    >
      <path
        d="M12 4.5C11.1716 4.5 10.5 5.17157 10.5 6C10.5 6.27614 10.2761 6.5 10 6.5C9.72386 6.5 9.5 6.27614 9.5 6C9.5 5.17157 8.82843 4.5 8 4.5C7.17157 4.5 6.5 5.17157 6.5 6C6.5 6.82843 7.17157 7.5 8 7.5H8.5V9.5H8C7.17157 9.5 6.5 10.1716 6.5 11C6.5 11.8284 7.17157 12.5 8 12.5H8.5V14.5H8C7.17157 14.5 6.5 15.1716 6.5 16C6.5 16.8284 7.17157 17.5 8 17.5C8.82843 17.5 9.5 16.8284 9.5 16C9.5 15.7239 9.72386 15.5 10 15.5C10.2761 15.5 10.5 15.7239 10.5 16C10.5 16.8284 11.1716 17.5 12 17.5C12.8284 17.5 13.5 16.8284 13.5 16C13.5 15.7239 13.7239 15.5 14 15.5C14.2761 15.5 14.5 15.7239 14.5 16C14.5 16.8284 15.1716 17.5 16 17.5C16.8284 17.5 17.5 16.8284 17.5 16C17.5 15.1716 16.8284 14.5 16 14.5H15.5V12.5H16C16.8284 12.5 17.5 11.8284 17.5 11C17.5 10.1716 16.8284 9.5 16 9.5H15.5V7.5H16C16.8284 7.5 17.5 6.82843 17.5 6C17.5 5.17157 16.8284 4.5 16 4.5C15.1716 4.5 14.5 5.17157 14.5 6C14.5 6.27614 14.2761 6.5 14 6.5C13.7239 6.5 13.5 6.27614 13.5 6C13.5 5.17157 12.8284 4.5 12 4.5ZM11.5 9.5H12.5V7.5H11.5V9.5ZM11.5 14.5H12.5V12.5H11.5V14.5Z"
        fill="currentColor"
      />
      <path
        d="M6 3C3.79086 3 2 4.79086 2 7C2 8.01111 2.38486 8.92783 3.02863 9.6C2.38386 10.2775 2 11.174 2 12.2222C2 13.2732 2.38556 14.1722 3.03246 14.85C2.38971 15.5343 2 16.4199 2 17.4444C2 19.1333 3.03347 20.5423 4.5 21.1127V21C4.5 20.7239 4.72386 20.5 5 20.5C5.27614 20.5 5.5 20.7239 5.5 21V21.7639C5.82167 21.8147 6.15406 21.8444 6.5 21.8444C6.64522 21.8444 6.78846 21.838 6.92941 21.8254C7.2532 22.5099 7.9304 23 8.72727 23H15.2727C16.0696 23 16.7468 22.5099 17.0706 21.8254C17.2115 21.838 17.3548 21.8444 17.5 21.8444C17.8459 21.8444 18.1783 21.8147 18.5 21.7639V21C18.5 20.7239 18.7239 20.5 19 20.5C19.2761 20.5 19.5 20.7239 19.5 21V21.1127C20.9665 20.5423 22 19.1333 22 17.4444C22 16.4199 21.6103 15.5343 20.9675 14.85C21.6144 14.1722 22 13.2732 22 12.2222C22 11.174 21.6161 10.2775 20.9714 9.6C21.6151 8.92783 22 8.01111 22 7C22 4.79086 20.2091 3 18 3C17.2057 3 16.4638 3.23345 15.8419 3.63692C14.7977 2.62758 13.4703 2 12 2C10.5297 2 9.20229 2.62758 8.15808 3.63692C7.53623 3.23345 6.79429 3 6 3ZM12.0002 4C10.1602 4 8.64261 5.39531 8.50293 7.18465C8.47579 7.45761 8.23222 7.66202 7.95926 7.63488C7.6863 7.60775 7.48189 7.36418 7.50902 7.09122C7.52153 6.96655 7.54382 6.84489 7.57524 6.72701C7.52351 6.52153 7.4961 6.30573 7.4961 6.08333C7.4961 5.2065 8.21928 4.5 9.10744 4.5C9.14076 4.5 9.17377 4.5012 9.20642 4.50356C9.92018 3.59007 10.9041 3 12.0002 3C13.0962 3 14.0801 3.59007 14.7939 4.50356C14.8265 4.5012 14.8595 4.5 14.8928 4.5C15.781 4.5 16.5042 5.2065 16.5042 6.08333C16.5042 6.30574 16.4768 6.52154 16.425 6.72702C16.4564 6.8449 16.4787 6.96656 16.4913 7.09123C16.5184 7.36419 16.314 7.60776 16.041 7.63489C15.7681 7.66202 15.5245 7.45761 15.4974 7.18465C15.3577 5.39531 13.8401 4 12.0002 4Z"
        fill="currentColor"
      />
    </svg>
  );
